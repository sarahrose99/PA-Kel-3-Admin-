  ...
  if($gambarLokasi != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, 'gambar/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                   ...
                   $query  = "UPDATE lokasi SET lokasiBerapa = '$lokasiBerapa', namaLokasi = '$namaLokasi', gambarLokasi = '$nama_gambar_baru'";
                    $query .= "WHERE id = '$id'";
                    ...
                    if(!$result){
                      ...
                      echo "<script>alert('Data berhasil diubah.');window.location='index.php?page=tampil_lokasi';</script>";
                    }
              } else {     
      ...
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      $query  = "UPDATE lokasi SET lokasiBerapa = '$lokasiBerapa', namaLokasi = '$namaLokasi'";
      $query .= "WHERE id = '$id'";
      $result = mysqli_query($koneksi, $query);
      // periska query apakah ada error
      if(!$result){
