  ...
  if($gambarProduk != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, 'gambar/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                   ...
                   $query  = "UPDATE infoproduk SET namaProduk = '$namaProduk', hargaProduk = '$hargaProduk', deskripsiProduk = '$deskripsiProduk', gambarProduk = '$nama_gambar_baru'";
                    $query .= "WHERE id = '$id'";
      ...
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      $query  = "UPDATE infoproduk SET namaProduk = '$namaProduk', hargaProduk = '$hargaProduk', deskripsiProduk = '$deskripsiProduk'";
      $query .= "WHERE id = '$id'";
      $result = mysqli_query($koneksi, $query);
      // periska query apakah ada error
      if(!$result){
